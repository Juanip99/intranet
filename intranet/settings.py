...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'panel' / 'templates'],  # Asegúrate de que esta ruta sea correcta
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
JAZZMIN_SETTINGS = {
    "site_title": "Uteplim Admin",
    "site_header": "Login",
    "site_brand": "Uteplim",
    "site_logo": "images/ICONO.png",
    "welcome_sign": "Welcome to Uteplim Admin",
    "copyright": "Uteplim",
    "topmenu_links": [
